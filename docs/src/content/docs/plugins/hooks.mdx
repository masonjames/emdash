...
Templates can also pass explicit page-scoped schema payloads on `event.page.structuredData` for richer metadata plugins like FAQ and HowTo builders.
  ...
  page: {
    ...
    structuredData?: {
      ...
      howTo?: {
        ...
        supply?: string[];
        tool?: string[];
        steps: Array<{ name?: string | null; text: string; image?: string | null }>;
      } | null;
    };
  }
}
